...
void busquedaglobal(string busqueda, int num)
{ // Recibe 2 parametros
	repe = 0;
	...
	{
		cout << endl
			 << "El numero de veces que un identificador tipo " << busqueda << "aparece en el archivo es: " << repe << endl;
	}
	else if (num == 2)
	{
		cout << endl
			 << "El numero de veces que el operador " << busqueda << " aparece en el archivo es: " << repe << endl;
	}
	else if (num == 3)
	{
		cout << endl
			 << "El numero de veces que el puntuador " << busqueda << " aparece en el archivo es: " << repe << endl;
	}
}
